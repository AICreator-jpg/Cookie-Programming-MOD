...
(function () {
    ...
    var BLOCK_TYPES = {
        ...
        sugarLumps: { label: '砂糖玉', kind: 'value', color: '#e8c45b', category: 'info' },
    ...
    function defaultBlock(type, x, y) {
        ...
        if (type === 'sugarLumps') block.info = 'count';
  ...
  <div class="cp-modal">
    ...
    function expressionLabel(p, id, seen) {
        ...
        if (def.kind === 'value') {
            ...
            if (b.type === 'sugarLumps') return escapeHtml('砂糖玉（所持数）');
    ...
    function getValueBlockValue(type, block) {
        ...
        if (type === 'sugarLumps') return (typeof Game !== 'undefined' && typeof Game.lumps === 'number') ? Game.lumps : 0;
        if (type === 'prestige') {
            if (typeof Game === 'undefined') return 0;
    ...
    function bindEvents(root) {
        ...
        root.querySelector('.cp-delete-block').addEventListener('click', function () {
