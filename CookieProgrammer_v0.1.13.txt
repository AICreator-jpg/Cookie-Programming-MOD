...
(function () {
    ...
    var RESET_MARKER_KEY = 'CookieProgrammerMod.v01.reset_0_1_13';
    var RESET_SAVED_DATA_ONCE = true;
    var RESET_MARKER_KEY = 'CookieProgrammerMod.v01.reset_0_1_9';
    var ROOT_ID = 'cp-root';
...
#${ROOT_ID} .cp-block .cp-input-field{width:62px;box-sizing:border-box;padding:3px;border:1px solid #777;border-radius:3px;background:#fff;color:#222;user-select:text;touch-action:auto;cursor:text}
    ...
    function bindBlockFields(el, block) {
        ...
        el.querySelectorAll('.cp-input-slot').forEach(function (slot) {
            ...
            slot.addEventListener('click', function (ev) {
                ...
                updateExpressionTargetVisuals();
                if (this.classList.contains('cp-input-field')) this.select();
