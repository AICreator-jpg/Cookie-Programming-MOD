...
(function () {
    ...
    var BLOCK_TYPES = {
        ...
        branch: { label: '条件分岐', kind: 'value', color: '#b07bd8', category: 'variables' },
...
<div class="cp-window">
  ...
  <div class="cp-modal">
    ...
    function blockInnerHtml(b) {
        ...
        if (b.type === 'branch') {
            return head + '<div style="text-align:center"><b>条件分岐</b></div>'
        ...
        if (b.type === 'sortDefinition') {
            ...
            return head + '<div style="text-align:center"><b>ソートを定義する</b></div>'
                ...
                + '<div>評価値：' + inputSlotHtml(p,b,'value') + '</div>'
    ...
    function renderSortEditor(){
        ...
        box.innerHTML='<div style="font-size:12px;margin-top:5px">対象：<b>'+escapeHtml(getSortTargetLabel(sort))+'</b></div>' +
            ...
            '<div style="font-size:11px;margin-top:4px">ソートの評価値は数値変数や計算式から作成できます。</div>';
